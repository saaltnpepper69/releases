...
COIN_TGZ='https://github.com/DarkPayCoin/releases/raw/master/1.4/LINUX64/DarkPayCoin-1.4LINUX64.zip'
...
echo -e "
▼ DarkPayCoin Installer v1.03
-----------------------------               
"

    echo -e "${GREEN}Welcome to $COIN_NAME VPS setup script for your masternode${NC}"
